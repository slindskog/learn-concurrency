...
if __name__ == '__main__':
    # This version still has a bug. The fix requires us to block any new threads from proceeding
    # until all the threads that have reached the previous barrier are released.
    barrier = Barrier(3)
