...
# Requests drop to 0 when long request starts
# Since there's a single event loop on which all coroutines get executed, a CPU-bound task
# brings the entire app to a stop.
